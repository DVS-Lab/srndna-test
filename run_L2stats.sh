...
for sm in 0 6; do
		...
		sub=$1
		nruns=$2
		bash code/L2_task-all_model-01_type-act.sh $sub $nruns $sm &
		sleep 10s
...
#			sub=$1
#			nruns=$2
#			bash code/L2_task-all_model-01_type-ppi.sh $sub $nruns $ppi $sm &
#			sleep 10s
#	
#		done
#	done
...
for ppi in "dmn" "ecn"; do
	...
	#for subrun in "135 5" "136 2" "137 5" "138 4"; do	
		...
		sub=$1
		nruns=$2
		bash code/L2_task-all_model-01_type-nppi.sh $sub $nruns $ppi &
		sleep 10s
